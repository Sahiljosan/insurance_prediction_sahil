...
class DataValidation:
    def __init__(self,data_validation_config:config_entity.DataValidatonConfig,
    ...
    def initiate_data_valiation(self)->artifact_entity.DataValidationArtifact: # initiate_data_validation will come from artifact_entity.DataValidationArtifact
        try:
